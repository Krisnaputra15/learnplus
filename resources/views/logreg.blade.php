...
<title>LearnPLUS | Login & Register</title>
...
<div class="col-lg-12">
    ...
    @endif
<form id="login-form" action="{{url('login-proses')}}" method="post" role="form" style="display: block;">
{{ csrf_field() }}
...
<label for="email_address">Login As</label>
<div class="form-group">
...
<form id="register-form" action="{{url('register-proses')}}" method="post" role="form" style="display: none;">
{{ csrf_field() }}
...
<label for="email_address">Register As</label>
<div class="form-group">
<select class="form-control" name="kategori">                                   
<option value="teacher">Teacher</option>     
<option value="student">Student</option>                            
