...
<title>LearnPLUS | Admin Login & Register</title>
...
<a href="{{url('home')}}"><img src="images/xlogin-logo.png.pagespeed.ic.rk5LaeLYSz.png" alt=""></a>
</div>
...
<div class="col-lg-12">
    ...
    @endif
<form id="login-form" action="{{url('login-proses-admin')}}" method="post" role="form" style="display: block;">
{{ csrf_field() }}
...
<form id="register-form" action="{{url('register-proses-admin')}}" method="post" role="form" style="display: none;">
{{ csrf_field() }}
<label for="fullname">Name</label>
<div class="form-group">
<input type="text" name="fullname" id="email" tabindex="1" class="form-control" placeholder="Full Name" value="" required="">
</div>
<label for="email">Email</label>
<div class="form-group">
...
<div class="row">
<div class="col-sm-12">
<button type="submit" class="form-control btn btn-default btn-block">Register an Admin Account</button>
</div>
</div>
</div>
</form>
