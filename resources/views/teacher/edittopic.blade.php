...
<form method="post" action="{{url('/edit-topic-process')}}" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="form-group">
<input type="hidden" name="tgl_edit" id="tgl_edit" class="form-control" placeholder="" value="{{date('Y-m-d h:i:sa')}}" required="">
</div>
...
<center>
<button type="submit" class="btn btn-default btn-lg" style="width:50%; border-radius: 0px;">Edit Topic</button><a href="{{url('topic-'.$topic->id.'-detail')}}" class="btn btn-primary btn-lg" style="width:50%; border-radius: 0px;">Back to topic detail</a>
</center>
</form>
<span> </span>
<center>
