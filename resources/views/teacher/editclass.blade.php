...
<h4>Edit Class</h4>
<p>Fill the form to edit this class please, teacher {{Session('fullname_user')}}</p>
</div>
</div>
<!-- form-->

<form method="post" action="{{url('/edit-class-process')}}" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="form-group">
<input type="hidden" name="id_guru" id="id_guru" class="form-control" placeholder="{{Session('id_user')}}" value="{{Session('id_user')}}"> 
</div>
<div class="form-group">
