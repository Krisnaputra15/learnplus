...
<p>Edit your profile in this page please, Teacher {{$profile->nama}}. And remember just fill the form which you want to update.</p>
<div class="edit-profile">
<form role="form" method="post" action="{{url('/edit-profile-'.$profile->id.'-process')}}" enctype="multipart/form-data">
{{ csrf_field() }}
