...
<img src='upload/profile_picture/teacher/{{$profile->picture}}' alt="Your Picture" class="img-responsive">
</div>
...
<hr>
<p>My Class <small class="label label-primary">{{$classcount}}</small></p>
<hr>
<p>My Topic <small class="label label-primary">40</small></p>
<hr>
...
<a href="{{url('/home-teacher')}}" class="btn btn-default" style="width:25%;"><i class="fa fa-search"></i> &nbsp; View Your Class</a> <a href="{{url('teacher-'.$profile->id.'-edit')}}" class="btn btn-primary" ><i class="fa fa-cogs"></i> &nbsp; Edit Your Profile Information</a> <a href="{{url('/logout')}}" class="btn btn-warning" style="width:22%;"><i class="fa fa-sign-out"></i> &nbsp; Logout</a>
