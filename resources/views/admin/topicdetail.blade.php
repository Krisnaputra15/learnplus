...
<li><a href="{{url('class-'.$class->id.'-topics-admin')}}">{{$class->nama_kelas}} Class</a></li>
<li><a href="{{url('topic-'.$topic->id.'-detail-admin')}}">{{$topic->nama_topik}} Topic</a></li>
...
<p class="course-category">Class : <a href="{{url('class-'.$class->id.'-topics-admin')}}">{{$class->nama_kelas}}</a></p>
<hr>
...
<a href="{{url('topic-'.$topic->id.'-edit-admin')}}" class="btn btn-primary" style="width:50%">Edit Topic</a><a href="{{url('topic-'.$topic->id.'-delete-admin')}}" class="btn btn-danger" style="width:50%">Delete Topic</a>
</div>
</div>
...
<h4>Files submitted by student</h4>
</div>
@if($filesubmitcount->count > 1)
<div class="course-table">
<table class="table">
<thead>
<tr>
...
@elseif($filesubmitcount->count < 2 && $filesubmitcount->count == 1)
<div class="course-table">
<table class="table">
<thead>
<tr>
