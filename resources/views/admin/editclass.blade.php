...
<h4>Make a Class</h4>
<p>Fill the form to edit this class please, Admin {{Session('fullname_user')}}</p>
</div>
</div>
<!-- form-->

<form method="post" action="{{url('/edit-class-process-admin')}}" enctype="multipart/form-data">
{{ csrf_field() }}
<label for="class_name">Class Name</label>
<div class="form-group">
<input type="text" name="nama_kelas" id="nama_kelas" class="form-control" placeholder="Your Class Name" value="{{$class->nama_kelas}}" required="">
</div>
<div class="form-group">
<input type="hidden" name="id_guru" id="id_guru" class="form-control" placeholder="{{$teacher->id}}" value="{{$teacher->id}}"> 
</div>
<div class="form-group">
<input type="hidden" name="id_kelas" id="id_kelas" class="form-control" placeholder="" value="{{$class->id}}"> 
</div>
<label for="exampleFormControlTextArea">Picture</label>
<div class="form-group">
<input type="file" name="picture" id="picture" class="form-control" placeholder="Your Class Name" value="">
</div>
<p style="color:grey;"><i>*fill this if you want to update your class picture</i></p>
<center>
<button type="submit" class="btn btn-default btn-lg" >Edit Class</button>
</center>
</form>
