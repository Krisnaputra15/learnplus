...
<h4>Make a Topic</h4>
<p>Fill the form to make a topic please, {{Session('fullname_user')}}</p>
</div>
</div>
<!-- form-->

<form method="post" action="{{url('/make-topic-process-admin')}}" enctype="multipart/form-data">
{{ csrf_field() }}
<div class="form-group">
<input type="hidden" name="id_kelas" id="id_kelas" class="form-control" placeholder="Your Class Name" value="{{$class->id}}" required="">
</div>
<label for="topic_name">Topic Name</label>
<div class="form-group">
<input type="text" name="topic_name" id="topic_name" class="form-control" placeholder="The Topic Name" value="" required="">
</div>
<label for="deskripsi">Description</label>
<div class="form-group">
<textarea name="deskripsi" id="deskripsi" class="form-control" placeholder="Add a description/instruction for your topic" value=""></textarea>
</div>
<label for="class_name">Deadline Date (Fill this if you want to set the deadline for the topic)</label>
<div class="form-group">
<input type="datetime-local" name="deadline" id="deadline" class="form-control" placeholder="" value=""> 
</div>
<div class="form-group">
<input type="hidden" name="tgl_buat" id="tgl_buat" class="form-control" placeholder="" value="{{date('Y-m-d h:i:sa')}}" required="">
</div>
...
<center>
<button type="submit" class="btn btn-default btn-lg" >Add Topic</button>
</center>
</form>
