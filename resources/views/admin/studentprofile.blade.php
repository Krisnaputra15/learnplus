...
<li class="active">{{$student->nama}} Profile Page</li>
</ol>
</div>
</div>
</div>
...
<img src='upload/profile_picture/student/{{$student->picture}}' alt="{{$student->nama}} Picture" class="img-responsive">
</div>
...
<a href="{{url('student-'.$student->id.'-edit-admin')}}" class="btn btn-primary" style="width:49%;"><i class="fa fa-cogs"></i> &nbsp; Edit Profile Information</a> <a href="{{url('delete-student-'.$student->id)}}" class="btn btn-danger" style="width:49%;"><i class="fa fa-trash-o"></i> &nbsp; Delete account</a>  
