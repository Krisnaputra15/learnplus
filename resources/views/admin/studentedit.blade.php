...
<img src='upload/profile_picture/student/{{$profile->picture}}' alt="" class="img-responsive">
</div>
...
<form role="form" method="post" action="{{url('/student-edit-profile-'.$profile->id.'-process-admin')}}" enctype="multipart/form-data">
{{ csrf_field() }}
...
<textarea type="text" name="about_urself" id="about_urself" class="form-control" placeholder="" value="">{{$profile->about_urself}}</textarea>
</div>
<div class="form-group">
