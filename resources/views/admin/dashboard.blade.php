...
<img src='upload/profile_picture/admin/{{$profile->picture}}' alt="Your Picture" class="img-responsive">
</div>
...
<h2>{{$profile->nama}}</h2>
<div class="shopmeta">
<span class="pull-left"><strong>Profession :</strong> Admin </span>
...
<a href="{{url('/home-admin')}}" class="btn btn-default" style="width:25%;"><i class="fa fa-search"></i> &nbsp; Back to home</a> <a href="{{url('admin-'.$profile->id.'-edit')}}" class="btn btn-primary" ><i class="fa fa-cogs"></i> &nbsp; Edit Your Profile Information</a> <a href="{{url('/logout')}}" class="btn btn-warning" style="width:22%;"><i class="fa fa-sign-out"></i> &nbsp; Logout</a> <a href="{{url('delete-admin-'.$profile->id)}}" class="btn btn-danger" style="width:21%;"><i class="fa fa-trash-o"></i> &nbsp; Delete account</a>  
