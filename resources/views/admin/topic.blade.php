...
<li><a href="{{url('class-'.$class->id.'-topics-admin')}}">{{$class->nama_kelas}}</a></li>
...
<h4><a href="{{url('topic-'.$classes2->id.'-detail-admin')}}">{{$classes2->nama_topik}}</a></h4>
<div class="shopmeta">
...
<a href="{{url('topic-'.$classes2->id.'-detail-admin')}}" class="btn btn-default">Select</a>
</div>
</div>
</div>
@else
...
<h2><i>Oops!<br> Look like Teacher {{$teacher->nama}} hasn't posted any topic yet.</i><br><i> post a topic by clicking <a href="{{url('class-'.$class->id.'-make-topic-admin')}}"><b>this link</b></a><br></i></h2>
</div>
@endif
<center>
<a class="btn btn-default btn-md" href="{{url('class-'.$class->id.'-make-topic-admin')}}">Add a topic</a>
<a class="btn btn-danger btn-md" href="{{url('class-'.$class->id.'-delete-admin')}}">delete class</a>
</center>
</div>
</div>
</section>
