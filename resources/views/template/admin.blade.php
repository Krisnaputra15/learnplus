@if(Session('login_status') == true and Session('level_user') == 'admin')
<!DOCTYPE html>
...
<li>
<a href="{{url('dashboard-admin')}}"><i class="fa fa-user"></i>{{Session('fullname_user')}}</a>
</li>
...
<div class="logo">
<a class="navbar-brand" href="{{url('home-admin')}}"><img src="images/xlogo.png.pagespeed.ic.vap6Ukaf0i.png" alt=""></a>
</div>
</div>
...
<li><a class="btn btn-primary" href="{{url('make-class-admin')}}">Make a Class</a></li>
</ul>
</div>
</div>
</div>
