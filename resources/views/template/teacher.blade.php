@if(Session('login_status') == true and Session('level_user') == 'teacher')
<!DOCTYPE html>
...
<li>
<a href="{{url('dashboard-teacher')}}"><i class="fa fa-user"></i>{{Session('fullname_user')}}</a>
</li>
...
<div class="logo">
<a class="navbar-brand" href="{{url('home-teacher')}}"><img src="images/xlogo.png.pagespeed.ic.vap6Ukaf0i.png" alt=""></a>
</div>
</div>
...
<li><a href="#">Topic(s)</a></li>
<li><a href="forums.html">Forum</a></li>
<li><a href="page-contact.html">Contact</a></li>
</ul>
<ul class="nav navbar-nav navbar-right">
<li><a class="btn btn-primary" href="{{url('make-class')}}">Make a Class</a></li>
</ul>
</div>
</div>
</div>
...
<li class="dropdown">
<a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-lock"></i>{{Session::get('id_user')}}</a>
...
<ul class="nav navbar-nav navbar-right">
<li><a class="btn btn-primary" href="{{url('logreg')}}"><i class="fa fa-sign-in"></i> Register Now</a></li>
</ul>
</div>
</div>
</div>
